...
public class Main {
            ...
            switch(opcion){
                ...
                case 2:
                    ...
                    if(opcionCompra == 1 && jugador1.getDinero() >= 5){
                        ...
                        System.out.println("No tienes fondos o has elegido una opci�n incorrecta");
                    }
                ...
                case 4:
                    ...
                    break;
                default:
                    System.out.println("Opci�n incorrecta, inténtelo de nuevo.");
                    break;
            }
        }while(salir == true);
    ...
    public static void bazarteria(){
        System.out.println("Visitas la Bazarter�a para comprar un arma");
        System.out.println("�Qu� deseas comprar?");
        System.out.println("1. Calculadora -> +3p de ataque -> 5 oros");
        System.out.println("2. Pu�o americano -> +5p de ataque -> 7 oros");
    ...
    public static void menuPrincipal(){
        ...
        System.out.println("Pulse 2 para ir a la tienda");
